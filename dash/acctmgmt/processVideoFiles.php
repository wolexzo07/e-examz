...
xstart("0");
if(x_validatepost("_token") && x_validatesession("XELOW_DOMINGOS_USER_ID") && x_validateget("switcher")){
		...
		$post_id = x_clean(sha1($_SESSION["XELOW_DOMINGOS_USER_ID"].xrands(10).DATE("YmdHis")));
